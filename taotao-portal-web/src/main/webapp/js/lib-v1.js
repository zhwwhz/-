...
//        var a = this;
//        $.ajax({url: ("https:" == document.location.protocol ? "https://" : "http://") + "passport." + pageConfig.FN_getDomain() + "/new/helloService.ashx?m=ls&cart=0",dataType: "jsonp",success: function(b) {
...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_Serv: "http://39.108.185.153:8081/rest/itemcat/all?callback=category.getDataService",
...
//            a && a.info && $("#loginbar").html(a.info), a && a.cart && $.each(a.cart, function() {
//                $.getJSON(this);
//                
//            })
//        }}), 
