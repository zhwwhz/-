...
<div class="easyui-panel" title="Nested Panel" data-options="width:'100%',minHeight:500,noheader:true,border:false" style="padding:10px;">
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'center'" style="padding:5px">
            <table class="easyui-datagrid" id="contentList" data-options="toolbar:contentListToolbar,singleSelect:false,collapsible:true,pagination:true,
...
var contentListToolbar = [{
    ...
    iconCls:'icon-add',
    handler:function(){
    	var node = $("#contentCategoryTree").tree("getSelected"); // 找到树形控件对象，获取选中的节点
		...
		TT.createWindow({
			...
			onLoad : function(){
				...
				$.post("/content/getContentText",{"id":data.id},function(rt){
					console.log("进入ajax");
					if(rt.status == 200) {
						contentEditEditor.html(rt.data.content);
					}
				});
			}
		});    	
    ...
    handler:function(){
    	...
    	$.messager.confirm('确认','确定删除ID为 '+ids+' 的内容吗？',function(r){
    	    if (r){
    	    	var params = {"ids":ids}; // [12,23,45,21,......]
