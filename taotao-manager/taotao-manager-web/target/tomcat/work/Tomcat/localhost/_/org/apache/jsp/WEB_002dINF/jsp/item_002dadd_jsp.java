 ...
 * Generated at: 2019-12-16 07:29:53 UTC
...
public final class item_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t$(function(){\r\n");
      out.write("\t\t// 创建富文本编辑器（实例化富文本编辑器）\r\n");
      out.write("\t\titemAddEditor = TAOTAO.createEditor(\"#itemAddForm [name=desc]\");\r\n");
      out.write("\t\t// 初始化类目选择和图片上传器\r\n");
      out.write("\t\tTAOTAO.init({fun:function(node){ // TAOTAO是一个js对象，在common.js中定义了\r\n");
      out.write("\t\t}});\r\n");
      out.write("\t});\r\n");
      out.write("\t// 提交表单\r\n");
      ...
      out.write("\t\t// $(\"#itemAddForm\").serialize() 将表单序列化为key-value形式的字符串，与java序列化没有半毛钱关系\r\n");
      out.write("\t\t$.post(\"/item/save\",$(\"#itemAddForm\").serialize(), function(data){\r\n");
      out.write("\t\t\tif(data.status == 200){\r\n");
      out.write("\t\t\t\t$.messager.alert('提示','新增商品成功!');\r\n");
      out.write("\t\t\t\t// 清空表单\r\n");
      out.write("\t\t\t\t$('#itemAddForm').form('clear');\r\n");
      out.write("\t\t\t\t// 清空图片\r\n");
      out.write("\t\t\t\t$(\".picFileUpload\").siblings(\"div.pics\").remove();\r\n");
      out.write("\t\t\t\t// 清空编辑器\r\n");
      out.write("\t\t\t\t$(\"iframe\").contents().find(\"body\").html(\"\");\r\n");
      out.write("\t\t\t}else{\r\n");
