 ...
 * Generated at: 2019-12-16 07:29:43 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("// 页面初始化完成之后，调用下面方法\r\n");
      out.write("$(function(){\r\n");
      out.write("\t$(\"#contentCategory\").tree({\r\n");
      out.write("\t\turl : '/content/category/list', // 初始化tree控件\r\n");
      ...
      out.write("            });\r\n");
      out.write("        },\r\n");
      out.write("        // 在添加节点被编辑之后触发\r\n");
      out.write("        onAfterEdit : function(node){\r\n");
      out.write("        \tvar _tree = $(this); // 获取树本身\r\n");
      ...
      out.write("\t// 获取被选中的节点，就是右击鼠标时的节点\r\n");
      out.write("\tvar node = tree.tree(\"getSelected\");\r\n");
      out.write("\t// 判断选择的是“添加”还是“重命名”还是“删除”\r\n");
      out.write("\tif(item.name === \"add\"){  // 在js中，1==1 true 1==\"1\" true\r\n");
      out.write("\t\ttree.tree('append', { // 在js中，1===1 true 1===\"1\" false\r\n");
      out.write("\t\t\t// 在被点击的节点下追加一个子节点\r\n");
      out.write("            parent: (node?node.target:null), // 被追加的子节点的父\r\n");
      out.write("            data: [{\r\n");
      out.write("                text: '新建分类', // 节点的内容\r\n");
      out.write("                id : 0, // 节点的id\r\n");
      out.write("                parentId : node.id // 新建节点的父节点的id\r\n");
      out.write("            }]\r\n");
      out.write("        }); \r\n");
      out.write("\t\tvar _node = tree.tree('find',0); // 获取根节点\r\n");
      out.write("\t\ttree.tree(\"select\",_node.target).tree('beginEdit',_node.target); // 开启编辑\r\n");
