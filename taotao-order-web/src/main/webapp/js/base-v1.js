 ...
 */
function login() {
    return location.href = "http://39.108.185.153:8088/user/loginogin";
}
function regist() {
    return location.href = "http://39.108.185.153:8084/user/register";
}
...
function search(a) {
    var b = "http://39.108.185.153:8085/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
