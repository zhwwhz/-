 ...
 */
function login() {
    return location.href = "http://39.108.185.153:8088/page/login";
}
function regist() {
    return location.href = "http://39.108.185.153:8088/page/register";
}
...
function search(a) {
    var b = "http://120.78.192.106:8084/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
