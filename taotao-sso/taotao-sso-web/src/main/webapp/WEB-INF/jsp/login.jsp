...
<div class="w">
    <div id="logo">
    	<a href="http://39.108.185.153:8081" clstag="passport|keycount|login|01">
...
<script type="text/javascript">
			...
			doLogin:function() {
				$.post("/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						...
						alert(redirectUrl)
						if (redirectUrl == "") {
							location.href = "http://39.108.185.153:8081";//默认跳转到首页
						} else {
							location.href = redirectUrl;//重新跳转到订单确认页面
						}
					} else {
	...
	$(function(){
		$("#loginsubmit").click(function(){ //动态绑定事件
			LOGIN.login();
		});
	});
</script>
